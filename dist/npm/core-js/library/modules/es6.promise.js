...
var anInstance = require('./_an-instance.js');
var forOf = require('./_for-of.js');
var speciesConstructor = require('./_species-constructor.js');
var task = require('./_task.js').set;
var microtask = require('./_microtask.js')();
var newPromiseCapabilityModule = require('./_new-promise-capability.js');
...
var USE_NATIVE = !!function () {
  try {
    ...
    var FakePromise = (promise.constructor = {})[require('./_wks.js')('species')] = function (exec) {
      exec(empty, empty);
    };
